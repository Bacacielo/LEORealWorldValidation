...
% APP_REALWORLDVALIDATION - LEO Constellation Weather & Physics Validator
%
% DESCRIPTION:
%   A high-fidelity visualization engine for validating LEO satellite links
%   under real-world conditions. It integrates SGP4 propagation with
%   atmospheric physics models to assess link viability.
%
% KEY FEATURES:
%   - Real-time SGP4 propagation of 2000+ Starlink satellites.
%   - ITU-R P.838 Rain Attenuation modeling (Ka-band).
%   - Dynamic Path Loss & Doppler Shift analysis for Ground-to-Sat links.
%   - Interactive 3D Globe with ground station selection.
...
% =========================================================================
	...
	% Check for required physics data (generated by Python backend)
	...
	function updateFrame(t)
		...
		% Create random loads (simulation placeholder)
		...
		if ~isempty(u) && ~isempty(v)
			...
			if length(paths) >= 1
                ...
                % relative to the first satellite in the chain.
				...
				% Radial Velocity (Projection of Satellite Velocity on Line-of-Sight)
                % (Ground velocity assumed ~0 in ECEF relative to orbital speed)
				v_radial_km_s = dot(V_sat, los_unit); 
				
				% Convert to Doppler (Hz) at Ka-band
				freq = 26e9; % 26 GHz
				c_km_s = 299792.458;
